...
function renderReadySection(section, sources = {}) {
  ...
  const rows = [
    ...
    briefRow("Dealer gamma", section.gamma, joinValues(
      section.gamma?.underlying,
      section.gamma?.regime,
      ...
      section.gamma?.insight?.interpretation,
      section.gamma?.insight?.horizon_interpretation,
      section.gamma?.insight?.skew_interpretation,
      section.gamma?.insight?.provenance,
    )),
