...
app-check: app-log-contract-check app-contract-check app-syntax-check app-browser-helper-check app-auth-check app-behavior-check app-governance-check app-active-alert-inbox-check app-alert-compat-check app-market-events-check app-service-worker-check ## Fast app gate: production logging + SPA contracts
...
app-governance-check: ## Execute governance refresh, cutover, and attempt-redaction contracts in a Node VM
	...
	node --test web/app/test/dom-harness.test.mjs web/app/test/governance-ui.test.mjs
...
CHECK_JOBS ?= 8
CHECK_TARGETS = $(CHECK_DEPS) agent-config-check commit-check-contract-check modernize-check docs-check docs-html-check changelog-check account-data-check product-identity-check release-packaging-check app-log-contract-check app-contract-check app-syntax-check app-browser-helper-check app-auth-check app-behavior-check app-governance-check app-active-alert-inbox-check app-alert-compat-check app-market-events-check app-service-worker-check remote-relay-check go-doc-check gofmt-check vet-check staticcheck-check govulncheck-check
