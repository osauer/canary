...
internal-docs/design/risk-policy.md (deferred list) and internal-docs/design/post-trade-truth.md
...
before/after artifacts per .agents/docs/daemon-cli-trading-contract.md.
