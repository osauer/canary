...
- **A treasury or bond no longer shows the daily move of the stock that shares its ticker.** Every non-option holding was priced by asking for a quote on its bare symbol as if it were a stock, so a treasury issue symbolled `T` was decorated with AT&T's quote — a bill held at 28 against AT&T's 98.5 printed a daily move of about 252%, and a five-figure daily P&L on a four-figure position. The holding itself was never wrong; the quote pinned beside it was. This became reachable only in v2.6.0: before it, the multiplier check discarded those rows before anything could price them, so fixing that fault is what exposed this one. Bonds, bills, funds and futures now keep the broker's own mark and carry no quote context and no day change, rather than a confident wrong one. Equities are unaffected.
