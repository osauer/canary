...
var Tools = []Tool{
	...
	},
	{
		...
		Description: strings.Join([]string{
			...
			"NOT for account-only risk such as margin breach, cash, buying power, or daily P&L in isolation — use `canary_account` or a dedicated account-risk workflow for that. Stress evidence may include margin/P&L facts, but the headline stress action is gated by market confirmation plus portfolio fit.",
