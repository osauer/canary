...
var presentations = map[rpc.AlertPresentationCode]Presentation{
	rpc.AlertPresentationPortfolioStress:                  {Title: "Portfolio stress", Body: "The current portfolio stress classification is watch or higher; open Stress for the measured drivers."},
	rpc.AlertPresentationMarginCushion:                    {Title: "Margin cushion", Body: "The account margin cushion is below its safety threshold."},
	rpc.AlertPresentationRegimeMarketStress:               {Title: "Market stress", Body: "Current broad-market evidence is at a stress threshold; open Market for the contributing bands and evidence quality."},
	rpc.AlertPresentationRulebookSingleNameExposure:       {Title: "Single-name exposure", Body: "One underlying is approaching or above its share-of-NLV concentration threshold; open Rules for the measured value and cap."},
	rpc.AlertPresentationRulebookOptionLinePremium:        {Title: "Option-line exposure", Body: "One non-hedge option line is above its advisory share-of-NLV threshold; open Rules for the measured value and cap."},
	...
	rpc.AlertPresentationRulebookCatalystCoverage:         {Title: "Catalyst coverage", Body: "Canary cannot confirm that every required catalyst check is currently covered; open Rules for the evidence state."},
	...
	rpc.AlertPresentationRulebookHedgeIntegrity:           {Title: "Hedge integrity", Body: "Canary cannot confirm that required hedge evidence currently satisfies the Rulebook; open Rules for the evidence state."},
	rpc.AlertPresentationRulebookExitDiscipline:           {Title: "Exit discipline", Body: "An exit-discipline rule needs attention."},
	rpc.AlertPresentationRulebookFXExposure:               {Title: "Currency exposure", Body: "Non-base-currency exposure is approaching or above its share-of-NLV threshold; open Rules for the measured value and cap."},
