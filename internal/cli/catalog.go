...
func catalogExtras() map[string]CommandSpec {
	return map[string]CommandSpec{
		...
		"stress":        {Flags: flags(boolFlag("details"), valueFlag("view", []string{"full", "alert"}), valueFlag("since", nil), valueFlag("until", nil), valueFlag("severity", nil), valueFlag("action", nil), valueFlag("limit", nil), boolFlag("json")), Subcommands: subcommands("history")},
