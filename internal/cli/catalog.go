...
func catalogExtras() map[string]CommandSpec {
	return map[string]CommandSpec{
		...
		"reporting":     {Group: GroupDesk, Brief: "Shared statement-reporting setup and health", Flags: flags(boolFlag("json")), Subcommands: subcommands("status"), Guard: GuardReadOnly},
