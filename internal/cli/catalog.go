...
func catalogExtras() map[string]CommandSpec {
	return map[string]CommandSpec{
		...
		"market":        {Group: GroupMarkets, Flags: flags(boolFlag("watch"), valueFlag("symbol", nil), valueFlag("range", []string{"1D", "5D", "1M", "6M", "YTD", "1Y", "5Y"}), valueFlag("sessions", nil), boolFlag("explain"), valueFlag("exchange", nil), valueFlag("type", []string{"STK", "IND", "CASH"}), valueFlag("currency", nil), boolFlag("json")), Subcommands: subcommands("tape")},
