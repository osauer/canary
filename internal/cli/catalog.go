...
func catalogExtras() map[string]CommandSpec {
	return map[string]CommandSpec{
		...
		"edge":          {Group: GroupDesk, Brief: "Broker-truth review of past trading decisions", Flags: flags(valueFlag("window", []string{"90d", "365d"}), valueFlag("horizon", []string{"1", "5", "20"}), valueFlag("limit", nil), valueFlag("change", nil), boolFlag("json")), Guard: GuardReadOnly},
