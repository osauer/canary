...
func init() {
	commands = []Command{
		...
		{"edge", "Automatic broker-truth review of account P/L and past decision price impact", "canary edge [--window 90d|365d] [--horizon 1|5|20] [--limit N] [--change ID] [--json]", runEdge},
