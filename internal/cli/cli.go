...
func init() {
	commands = []Command{
		...
		{"proposals", "Daemon-owned close/reduce-only protection proposals", "canary proposals status|refresh|list|preview|prepare|prepared-status|submit|reduce|request-stop|ignore|veto [--json]", runProposals},
