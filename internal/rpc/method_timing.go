...
var methodTimings = []MethodTiming{
	...
	{Method: MethodDataHealth, Lifetime: MethodLifetimeUnary, DaemonTimeout: 5 * time.Second},
	...
	{Method: MethodAlertDeliveryProof, Lifetime: MethodLifetimeUnary, DaemonTimeout: 2 * time.Second},
