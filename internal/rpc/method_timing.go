...
var methodTimings = []MethodTiming{
	...
	{Method: MethodScanRun, Lifetime: MethodLifetimeUnary, DaemonTimeout: 75 * time.Second},
	{Method: MethodScanList, Lifetime: MethodLifetimeUnary, DaemonTimeout: 5 * time.Second},
	{Method: MethodScanParams, Lifetime: MethodLifetimeUnary, DaemonTimeout: 15 * time.Second},
	...
	{Method: MethodPurgeStatus, Lifetime: MethodLifetimeUnary, DaemonTimeout: 5 * time.Second},
	{Method: MethodPurgeExecute, Lifetime: MethodLifetimeUnary, DaemonTimeout: 55 * time.Second},
	{Method: MethodPurgeRestorePreview, Lifetime: MethodLifetimeUnary, DaemonTimeout: 55 * time.Second},
	{Method: MethodPurgeRestoreExecute, Lifetime: MethodLifetimeUnary, DaemonTimeout: 55 * time.Second},
