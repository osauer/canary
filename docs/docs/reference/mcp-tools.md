...
| `history` | boolean | no | Default false. Read the durable archive with first/latest captures and one/three/five-session price changes. No score or trading rule. |
